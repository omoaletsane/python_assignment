...
def plot_graph_from_two_functions(scatter_function, line_function, squared_error):
    """
    Plot a scatter for the train_function and a line for the ideal_function.
...
def plot_classification(point, ideal_function):
    """
    Plot the classification function and a point on top. It also displays the tolerance.
